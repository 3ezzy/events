...
const Index = () => {
  ...
  const featuredServices = [
    ...
    },
    {
      ...
      imageSrc: "https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?auto=format&fit=crop&q=80",
    ...
    },
    {
      ...
      icon: <Music2 size={24} />,
      imageSrc: "https://images.unsplash.com/photo-1520637836862-4d197d17c69a?auto=format&fit=crop&q=80",
      link: "/services#dj"
    }
  ];
      ...
      <section className="py-20 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-12">
            ...
            <Link 
              to="/services"
              className="mt-4 sm:mt-0 flex items-center text-psyco-green hover:text-psyco-green-light transition-colors"
            >
              View all services
      ...
      <section className="py-20 px-6 md:px-12 bg-psyco-black-light">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-12 text-center">
            <Link
              to="/booking"
              className="inline-flex items-center bg-psyco-green hover:bg-psyco-green-dark text-white font-medium py-3 px-8 rounded-lg transition-all duration-300 btn-glow"
            >
              Book Your Event
